...
urlpatterns = [
    ...
    path('edit/', bv.edit_list, name='edit_list'),
    path('edit_post/<int:key>', bv.post_edit, name="post_edit"),
    path('delete_post/<int:key>', bv.post_delete, name="post_delete"),
    path('edit_comment/', bv.comment_list, name='edit_comment_list'),
    path('edit_comment/<int:key>', bv.comment_edit, name='comment_edit'),
    path('delete_comment/<int:key>', bv.comment_delete, name='comment_delete'),
